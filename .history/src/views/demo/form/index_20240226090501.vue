  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const formItems = [
        ...
        { id: '1', model: 'input1', radioModel: 'radio1', radioLabel: '选项B:' },
        { id: '1', model: 'input1', radioModel: 'radio1', radioLabel: '选项C:' },
        { id: '1', model: 'input1', radioModel: 'radio1', radioLabel: '选项D:' },
        // 定义其他表单项...
      ]
