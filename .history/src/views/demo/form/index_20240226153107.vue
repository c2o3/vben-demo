<template>
  <a-form :model="formModel">
    <a-row v-for="item in formItems" :key="item.id">
      <a-col :span="2.5">
        <a-radio-group v-model="selectedRadio" name="radioGroup">
          <a-radio :value="item.id" checked="true">{{ item.radioLabel }}</a-radio>
        </a-radio-group>
      </a-col>
      <a-col :span="12">
        <a-form-item>
...
<script>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      return { formItems, selectedRadio }
    },
  })
</script>
