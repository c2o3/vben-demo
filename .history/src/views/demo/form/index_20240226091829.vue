  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const formItems = [
        ...
        { id: '2', model: 'input1', radioModel: 'radio2', radioLabel: '选项B:' },
        { id: '3', model: 'input1', radioModel: 'radio3', radioLabel: '选项C:' },
        { id: '4', model: 'input1', radioModel: 'radio4', radioLabel: '选项D:' },
        // 定义其他表单项...
      ]
